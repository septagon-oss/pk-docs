...
| AC-8 | Test | `modules/platformkit-business-modules/auth_management/features/permissions/session_evaluator_test.go::TestSessionPermissionEvaluatorLiveGuestCeilingOverridesStaleAdminClaim`, with Topaz and tenant-admin ordering cases. |
