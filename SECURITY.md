...
See also: [open-core.md](docs/v0.1.0/open-core.md) for what the OSS security baseline
covers, [quickstart.md](docs/v0.1.0/quickstart.md) for the honest caveat about the open
`/admin` dashboard.
